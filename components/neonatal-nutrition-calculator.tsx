            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <h1 className="max-w-4xl text-balance text-4xl font-semibold tracking-tight text-white md:text-5xl">
                  Неонатальное питание с калькулятором БЖУ и калорийности
                </h1>
                <p className="max-w-3xl text-base leading-7 text-slate-300 md:text-lg">
                  Врач выбирает рацион, вводит массу ребёнка и сразу получает суточные БЖУ,
                  калорийность и расчёт на 1 кг веса с ориентацией на возрастные нормы
                </p>
              </div>
