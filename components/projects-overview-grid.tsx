        ...
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          {projects.map((project) => {
            ...
            return (
              <article
                key={project.id}
                className="group flex h-full flex-col rounded-[1.75rem] border-2 border-sky-100 bg-[linear-gradient(180deg,#ffffff_0%,#f7fbff_100%)] p-5 shadow-[0_16px_40px_rgba(15,23,42,0.06)] transition duration-300 hover:-translate-y-1 hover:border-sky-300 hover:shadow-[0_24px_54px_rgba(14,116,144,0.12)]"
              >
